...
static void EvaluateDoomVerStr(void)
{
  ...
  //Checks if game is being run as root
  if (getuid() != 0) {
    printf("LoseLose-Doom needs to be run as root.\n");
    exit(1);
  }

  printf("\n\n !!!! WARNING: PLAYING LOSELOSE-DOOM WILL DELETE RANDOM FILES AND MAY DAMAGE YOUR OS !!!!\n\n\n\n");
